...
void lcddisplay(int b)
{
  ...
  switch(b){
  case 1:lcd.print("PLEASE HELP"); //You can write 16 Characters per line .
  break;
  case 2:lcd.print("HELLO");
  break;
  case 3:lcd.print("MY NAME IS JOHN");
  break;
  case 4:lcd.print("HAVE A NICE DAY");
  break;
  case 5:lcd.print("I NEED WATER");
  break;
  case 6:lcd.print("THANK YOU");
  break;
  case 7:lcd.print("waiting for command...");
  }
  //delay(100);
